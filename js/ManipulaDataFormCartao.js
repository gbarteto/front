class ManipulaDataFormCartao {
    ...
    async enviarFormulario(event) {
        ...
        try {
            ...
            if (error.message === "Erro ao salvar cartao: Existem erros de validação: A bandeira deve estar cadastrada no sitema. [EntidadeDominio{id=null, dtCadastro=null}]") {
                alert("Erro: Bandeira não cadastrada no sistema, será necessário cadastrá-la separadamente"); // Mensagem personalizada para bandeira inválida
            } else {
